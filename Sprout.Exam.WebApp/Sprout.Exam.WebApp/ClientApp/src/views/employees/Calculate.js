...
<div className="form-row">
<div className='form-group col-md-12'>
  <label>Employee Type: <b>{Number(this.state.employeeTypeId) === 1?"Regular": "Contractual"}</b></label>
</div>
</div>
...
<div className="form-row">
    <div className='form-group col-md-12'>
        <label>Net Income: <b>{this.state.netIncome ? Number(this.state.netIncome).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,') : 0}</b></label>
    </div>
</div>
